...
export const Topbar: React.FC<TopbarProps> = ({
  ...
  return (
    <header className="h-14 border-b bg-card border-border flex items-center justify-between px-4 sm:px-5 shrink-0">
      <button
        onClick={onMenuToggle}
        className="p-1.5 rounded-md hover:bg-muted/60 hover:text-foreground text-muted-foreground lg:hidden shrink-0 focus-ring"
      ...
      <div className="flex items-center gap-1.5 ml-auto">
        ...
        >
          ...
          <kbd className="hidden sm:inline-flex h-5 items-center gap-0.5 rounded border bg-muted px-1.5 font-mono text-xs font-medium text-muted-foreground">
            ⌘K
          </kbd>
        </button>
