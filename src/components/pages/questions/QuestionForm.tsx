...
export const QuestionForm: React.FC<QuestionFormProps> = ({
  ...
  const hasContent = !!(
    watchText ||
    (Array.isArray(watchOptions) && watchOptions.some(Boolean))
  );
          ...
          <div className="relative border-b border-border/40 bg-card">
            <div className="relative z-10 flex items-center justify-between px-6 py-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <Dialog.Title className="text-2xl font-semibold tracking-[-1.0px] text-foreground">
                    {question
              ...
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={onClose}
                  className="inline-flex items-center justify-center rounded-full border border-input bg-background px-5 py-2 text-sm font-semibold text-foreground hover:bg-muted transition-all duration-200 shadow-sm"
                >
                  Cancel
                </button>
                <button
                ...
                >
                  ...
                  <section className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-xs font-bold tracking-widest text-foreground font-heading">
                        Question Content
                      </h3>
                    </div>
                    <textarea
                      {...register("text")}
                      rows={3}
                      className="w-full rounded-2xl border border-input bg-card px-4 py-3 min-h-[80px] text-sm text-foreground placeholder-muted-foreground outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-shadow duration-200 resize-y"
                  ...
                  <section className="space-y-2">
                    <div className="flex items-center gap-1.5">
                      <ImageIcon className="h-3.5 w-3.5 text-muted-foreground/80" />
                      <span className="text-[11px] font-semibold tracking-wide text-muted-foreground/80">
                        Image
                      </span>
                      <span className="text-[9px] font-medium text-muted-foreground/50 ml-1">
                        (Optional)
                      </span>
                    </div>
                  ...
                  <section className="space-y-2">
                    <div className="flex items-center gap-1.5">
                      <ListChecks className="h-3.5 w-3.5 text-muted-foreground/80" />
                      <span className="text-[11px] font-semibold tracking-wide text-muted-foreground/80">
                        Answer Options
                      </span>
                    </div>
                  ...
                  <section className="space-y-2">
                    <div className="flex items-center gap-1.5">
                      <MessageSquareText className="h-3.5 w-3.5 text-muted-foreground/80" />
                      <span className="text-[11px] font-semibold tracking-wide text-muted-foreground/80">
                        Explanation
                      </span>
                      <span className="text-[9px] font-medium text-muted-foreground/50 ml-1">
                    ...
                    <textarea
                      ...
                      rows={2}
                      className="w-full rounded-2xl border border-input bg-card px-4 py-3 min-h-[60px] text-sm text-foreground placeholder-muted-foreground outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-shadow duration-200 resize-y"
